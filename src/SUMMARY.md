...
- [K8S Homelab](./infrastructure/introduction.md)
  - [Product Intro](./infrastructure/k8s-homelab/intro.md)
    - [Safety Checks & Start with Clean baseline](./infrastructure/k8s-homelab/safety-checks-and-cleaning.md)
    - [Setup Wireguard](./infrastructure/k8s-homelab/setup-wireguard.md)
    - [Setup Kubernetes and Calico](./infrastructure/k8s-homelab/setup-k3s-with-calico-vxlan.md)
    - [Setup Traefik](./infrastructure/k8s-homelab/setup-traefik.md)
    - [Test Ingress](./infrastructure/k8s-homelab/test-app-and-enable-tls.md)
    - [App deployment with kustomize](./infrastructure/k8s-homelab/app-deployment-with-kustomize.md)
    - [Harden Edge Node](./infrastructure/k8s-homelab/harden-on-edge.md)
    - [Let’s Encrypt with cert-manager (Cloudflare DNS-01)](./infrastructure/k8s-homelab/lets-encrypt-with-cert-manager-and-cloudflare.md)
    - [Setup postgres](./infrastructure/k8s-homelab/setup-postgresql.md)
