...
*Database name: [MyDatabase](https://github.com/DataWithBaraa/sql-ultimate-course/blob/main/datasets/sql-server/init-sql-server-mydatabase.sql)* :
...
*Database name: [SalesDB](https://github.com/DataWithBaraa/sql-ultimate-course/blob/main/datasets/sql-server/init-sqlserver-salesdb.sql)* :
```sql
/*
=============================================================
Database Creation and Table Setup Script
...
For PostgreSQL: 
- [MyDatabase](https://github.com/DataWithBaraa/sql-ultimate-course/blob/main/datasets/postgres/init-postgres-mydatabase.sql)
- [SalesDB](https://github.com/DataWithBaraa/sql-ultimate-course/blob/main/datasets/postgres/init-postgres-salesdb.sql) 

---

For MySQL:
- [MyDatabase](https://github.com/DataWithBaraa/sql-ultimate-course/blob/main/datasets/mysql/init-mysql-mydatabase.sql)
- [SalesDB](https://github.com/DataWithBaraa/sql-ultimate-course/blob/main/datasets/mysql/init-mysql-salesdb.sql)
